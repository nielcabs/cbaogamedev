...
<section class="flex flex-col justify-start md:justify-center items-center w-full h-full space-y-4 text-center">
	<div class="p-4 space-y-4 md:space-y-8">
		<header>
			<img src="/images/undecidev.png" class="invert-[0.9] dark:invert-0 animFloat w-[100px] md:w-auto mx-auto py-6" alt="logo" />
			<h2 class="uppercase">UndeciDev</h2>
			<span class="text-sm opacity-75">The portfolio of Juniel Cabo</span>
		</header>
