...
<div class="w-full h-full flex-auto block lg:flex overflow-auto lg:overflow-hidden">
	...
	<div class="flex-none lg:flex-[50%] p-4 overflow-x-auto space-y-8">
		...
		<section class="space-y-4">
			<h2>Characters</h2>
			<p>
				Shown in <span class="badge variant-filled-secondary">blue</span> - interact and chat with Juniel and other special guests.
			</p>
		...
		<section class="space-y-4">
			<h2>Pillars</h2>
			<p>
				Shown in <span class="badge variant-filled-primary">pink</span> - each represents a project Juniel has created or contributed to
			</p>
			<!-- Per Each Category -->
