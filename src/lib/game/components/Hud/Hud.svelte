...
>
	<img src="/images/undecidev.png" class="invert-[0.9] dark:invert-0 w-[40px] h-[40px]" alt="logo" />
	<div>
		<span class="block text-2xl font-bold uppercase">UndeciDev</span>
		<span class="block text-xs opacity-70">The portfolio of Juniel Cabo</span>
	</div>
</a>
