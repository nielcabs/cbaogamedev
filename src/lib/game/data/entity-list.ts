...
export const npcsList: any = (config: any) => {
	return [
		...
		new GameObject({
			...
			portrait: 'entities/npcs/npc-pearly.png',
			pathName: 'npc-circle',
			animatedSpriteSettings: { width: 2, height: 3 },
			containerSettings: { x: 40, y: 60, width: 2, height: 3 },
			dialog: `Hi, I'm Juniel' girlfriend. I'm here to help! If you get lost, simply tap the <strong class="text-primary-500">Navigate Button</strong>. This will help you quickly and easily navigate the between available characters and projects.`,
			interactive: true
		})
	];
};
...
export const catsList: any = (config: any) => {
	return [
		new Cat({
			...
			portrait: 'entities/critters/critter-toshi-portrait.png',
			dialog: `Arffff Arfff! I'm Toshi the great. Juniel and Pearly are my parents. Try the <strong class="text-primary-500">♫ Button</strong> to hear some chill tunes while you explore this world.`,
