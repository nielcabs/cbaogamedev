		...
		projects: [
			{
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/skeleton-labs/skeleton/001.jpg`, caption: 'Homepage - part 1' }, // caption: ''
					{ src: `/screenshots/skeleton-labs/skeleton/002.jpg`, caption: 'Homepage - part 2' },
					{ src: `/screenshots/skeleton-labs/skeleton/003.jpg` },
					{ src: `/screenshots/skeleton-labs/skeleton/004.jpg` },
					{ src: `/screenshots/skeleton-labs/skeleton/005.jpg`, caption: 'Skeleton branding' }
				]
			},
			{
				id: 'skeleton-labs',
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/skeleton-labs/skeleton-labs/001.jpg` } // caption: ''
				]
			}
		]
	},
		...
		projects: [
			{
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/brain-and-bones/branding/001.png`, caption: 'The Brain & Bones logo' },
					{ src: `/screenshots/brain-and-bones/branding/002.png`, caption: 'The Brain & Bones brand colors' },
					{ src: `/screenshots/brain-and-bones/branding/003.png`, caption: 'Font and Typography sets' },
					{ src: `/screenshots/brain-and-bones/branding/004.png`, caption: 'The company website' }
				]
			},
			{
				id: 'helm',
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/brain-and-bones/helm/001.png`, caption: 'The quiz selection UI' },
					{ src: `/screenshots/brain-and-bones/helm/002.png`, caption: 'Quiz metrics dashboard' },
					{ src: `/screenshots/brain-and-bones/helm/003.png`, caption: 'Attached quiz media' },
					{ src: `/screenshots/brain-and-bones/helm/004.png`, caption: 'Organization navigation' }
				]
			},
			{
				id: 'speed-trivia',
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/brain-and-bones/speed-trivia/001.png`, caption: 'The promotional marketing website' },
					{ src: `/screenshots/brain-and-bones/speed-trivia/002.png`, caption: 'The company logo' },
					{ src: `/screenshots/brain-and-bones/speed-trivia/003.png`, caption: 'Speed Trivia game main menu' },
					{
						src: `/screenshots/brain-and-bones/speed-trivia/004.png`,
						caption: 'Game start screen. The rocket and moon oribit the planet!'
					},
					{ src: `/screenshots/brain-and-bones/speed-trivia/005.png`, caption: 'Core trivia gameplay on desktop' },
					{ src: `/screenshots/brain-and-bones/speed-trivia/006.png`, caption: 'The live leaderboard standings' },
					{ src: `/screenshots/brain-and-bones/speed-trivia/007.png`, caption: 'Advertisements created for Speed Trivia' }
				]
			}
		]
	},
		...
		projects: [
			{
				...
				screenshots: [
					{ src: `/screenshots/jackpot-rising/branding/001.png`, caption: 'The comapny website' },
					{ src: `/screenshots/jackpot-rising/branding/002.png`, caption: 'The Jackpot Rising logo and brand colors' },
					{ src: `/screenshots/jackpot-rising/branding/003.png`, caption: 'Branded shirts for staff' }
				]
			},
			{
				id: 'overwolf',
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/jackpot-rising/overwolf/001.png`, caption: 'Navigating available tournaments' },
					{ src: `/screenshots/jackpot-rising/overwolf/002.png`, caption: 'Tournament Details and entry' },
					{ src: `/screenshots/jackpot-rising/overwolf/003.png`, caption: 'The login page' },
					{ src: `/screenshots/jackpot-rising/overwolf/008.png`, caption: 'Dreamhack Dallas 2019' },
					{
			...
			},
			{
				...
				screenshots: [
					{ src: `/screenshots/jackpot-rising/arcade/001.png`, caption: 'The skeeball device' },
					{ src: `/screenshots/jackpot-rising/arcade/002.png`, caption: 'The puttskee device' }
				]
			},
			{
				id: 'Portfolio',
				...
				details: [
					'This is my Personal Portfolio which still having an updates on the list of works that I do.'
				],
				technology: 'Angular, Angular Material, Typescript, SASS, Moment, Chart.js, VueJs',
				url: null,
				coords: { x: 48, y: 31 },
				accent: '#FFFFFF',
				thumbnail: `/works/jr-portfolio.png`,
				videos: [],
				screenshots: [
					{ src: `/screenshots/jackpot-rising/homebase/001.png`, caption: 'Main View' },
					{ src: `/screenshots/jackpot-rising/homebase/002.png`, caption: 'Web Projects' },
					{ src: `/screenshots/jackpot-rising/homebase/003.png`, caption: 'Web Extensions' },
					{ src: `/screenshots/jackpot-rising/homebase/004.png`, caption: 'Web Games' },
					{ src: `/screenshots/jackpot-rising/homebase/005.png`, caption: 'Introductions' },
					{ src: `/screenshots/jackpot-rising/homebase/006.png`, caption: 'Small Details' }
				]
			},
			{
				id: 'playerhq',
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/jackpot-rising/playerhq/001.png`, caption: 'Active list of tournaments' },
					{ src: `/screenshots/jackpot-rising/playerhq/002.png`, caption: 'Tournament details and leaderboard' },
					{ src: `/screenshots/jackpot-rising/playerhq/003.png`, caption: 'List of available games' },
					{ src: `/screenshots/jackpot-rising/playerhq/004.png`, caption: 'The game details view' },
					{ src: `/screenshots/jackpot-rising/playerhq/005.png`, caption: 'Support View' },
					{ src: `/screenshots/jackpot-rising/playerhq/006.png`, caption: 'Account and fund management' },
					{ src: `/screenshots/jackpot-rising/playerhq/007.png`, caption: 'Early mockup of the PlayerHQ app' },
					{ src: `/screenshots/jackpot-rising/playerhq/007.png`, caption: 'Early mockup of the PlayerHQ app' },
			...
			},
			{
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/jackpot-rising/speedleague/001.png`, caption: 'The in-game overlay UI' },
					{ src: `/screenshots/jackpot-rising/speedleague/002.png`, caption: 'Main Menu' },
					{ src: `/screenshots/jackpot-rising/speedleague/003.png`, caption: 'Track Selection' },
					{ src: `/screenshots/jackpot-rising/speedleague/004.png`, caption: 'Vehical selection and customization' },
					{ src: `/screenshots/jackpot-rising/speedleague/005.png`, caption: 'An tntro cinematic for the Tucson map' },
					{ src: `/screenshots/jackpot-rising/speedleague/006.png`, caption: 'Pause Menu' },
					{ src: `/screenshots/jackpot-rising/speedleague/007.png`, caption: 'Race Results' },
					{ src: `/screenshots/jackpot-rising/speedleague/008.png`, caption: 'Loading Screen' },
					{ src: `/screenshots/jackpot-rising/speedleague/009.png`, caption: 'Game Settings' }
				]
			}
		]
	},
		...
		projects: [
			{
				...
				screenshots: [
					{ src: `/screenshots/gaming/minirl/001.png`, caption: 'The promotional website' },
			...
			},
			{
				...
				videos: [],
				screenshots: [
					{ src: `/screenshots/gaming/elden-ring-planner/001.png`, caption: 'Your selected gear' },
					{ src: `/screenshots/gaming/elden-ring-planner/002.png`, caption: 'Browsing available armaments' }
				]
			}
		]
	}
